...
export function AiInterpretation({ type, targetId }: AiInterpretationProps) {
  ...
  return (
    <div>
      ...
      {error && (
        <div className="mt-3 text-sm px-3 py-2 rounded bg-red-900/30 text-red-700">
          {error}
      ...
      {result && (
        <div className="mt-4 bg-gradient-to-br from-green-50/70 to-purple-50/70 backdrop-blur-lg border border-emerald-500/20/50 rounded-2xl overflow-hidden">
          <button
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="text-xs text-green-600 hover:text-emerald-300"
              >
                Refazer
              </button>
          ...
          {expanded && (
            <div className="px-4 pb-4 space-y-4">
              <div>
                <p className="text-sm text-gray-300 whitespace-pre-wrap">{result.interpretation}</p>
              </div>
