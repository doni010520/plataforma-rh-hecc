        ...
        <div className="mt-4 bg-gradient-to-br from-indigo-50/70 to-purple-50/70 backdrop-blur-lg border border-indigo-200/50 rounded-2xl overflow-hidden">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-indigo-900 text-sm">Interpretação IA</span>
            </div>
            <div className="flex items-center gap-2">
              <button
              ...
              <svg className={`w-4 h-4 text-indigo-500 transition-transform ${expanded ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {expanded && (
            <div className="px-4 pb-4 space-y-4">
              ...
              {result.highlights.length > 0 && (
                <div>
                  <h4 className="text-xs font-semibold text-indigo-800 uppercase tracking-wide mb-2">Destaques</h4>
              ...
              {result.recommendations.length > 0 && (
                <div>
                  <h4 className="text-xs font-semibold text-indigo-800 uppercase tracking-wide mb-2">Recomendações</h4>
                  <ul className="space-y-1">
