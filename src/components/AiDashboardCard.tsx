...
export function AiDashboardCard() {
  ...
  return (
    <div className="mt-6 bg-gradient-to-br from-green-50/70 to-purple-50/70 backdrop-blur-lg border border-green-200/50 rounded-2xl p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link href="/inteligencia-artificial" className="text-sm text-green-700 hover:text-green-900 font-medium">
          Ver mais
        </Link>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-4">
        <div className="bg-white/70 rounded-lg p-3 text-center">
          <p className="text-xl font-bold text-green-700">{data.totalAnalyses}</p>
          <p className="text-xs text-gray-500">Análises</p>
        </div>
        <div className="bg-white/70 rounded-lg p-3 text-center">
          <p className="text-xl font-bold text-green-700">{data.totalAlerts}</p>
