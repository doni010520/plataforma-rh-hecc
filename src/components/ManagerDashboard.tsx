    ...
    <div className="mt-8">
      ...
      <div className="bg-gray-900/50 backdrop-blur-lg rounded-lg shadow-sm overflow-hidden">
        ...
        {(data.subordinateStatus?.length ?? 0) === 0 ? (
          <p className="p-6 text-sm text-gray-400">Nenhum liderado encontrado.</p>
        ) : (
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-800/30 text-left">
                <tr>
                  ...
                  <th className="px-6 py-3 text-xs font-medium text-gray-400 uppercase">Aval. Pend.</th>
                  <th className="px-6 py-3 text-xs font-medium text-gray-400 uppercase">OKRs</th>
                  <th className="px-6 py-3 text-xs font-medium text-gray-400 uppercase">Feedbacks</th>
                </tr>
              </thead>
                  ...
                  <tr key={sub.id} className="hover:bg-gray-800/30">
                    <td className="px-6 py-3">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <p className="font-medium text-gray-100">{sub.name ?? 'Sem nome'}</p>
                    ...
                    <td className="px-6 py-3 text-gray-300">{sub.okrCount}</td>
