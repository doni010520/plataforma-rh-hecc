    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-white rounded-lg shadow-sm p-4">
          <h3 className="text-sm font-medium text-gray-500 mb-1">Taxa de Resposta</h3>
          <p className="text-2xl font-bold text-gray-900">{data.responseRate.toFixed(0)}%</p>
          <p className="text-xs text-gray-400">{data.totalResponses} de {data.totalUsers} colaboradores</p>
        </div>
        <div className="bg-white rounded-lg shadow-sm p-4">
          <h3 className="text-sm font-medium text-gray-500 mb-1">Respostas</h3>
          <p className="text-2xl font-bold text-gray-900">{data.totalResponses}</p>
        </div>
        <div className="bg-white rounded-lg shadow-sm p-4">
          <h3 className="text-sm font-medium text-gray-500 mb-1">Perguntas</h3>
          <p className="text-2xl font-bold text-gray-900">{data.questionResults.length}</p>
        </div>
      </div>

      {/* Department Response Rate */}
      <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Taxa de Resposta por Departamento</h2>
      ...
      <div className="space-y-6">
        {data.questionResults.map((qr, i) => (
          <div key={qr.questionId} className="bg-white rounded-lg shadow-sm p-6">
            <h3 className="text-sm font-medium text-gray-500 mb-1">Pergunta {i + 1}</h3>
            <p className="font-semibold text-gray-900 mb-4">{qr.text}</p>
