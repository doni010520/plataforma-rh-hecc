...
export default function OnboardingDetailPage() {
  ...
  if (!process) return (<div className="text-center py-12"><p className="text-gray-500">Processo não encontrado.</p><Link href="/onboarding" className="text-indigo-600 hover:text-indigo-800 text-sm mt-2 inline-block">← Voltar para Onboarding</Link></div>);
  ...
  return (
    <div className="space-y-6">
      <Link href="/onboarding" className="text-sm text-indigo-600 hover:text-indigo-800">← Voltar para Onboarding</Link>
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div className="mt-4"><div className="flex justify-between text-sm text-gray-500 mb-1"><span>Progresso: {completedTasks}/{totalTasks} tarefas</span><span>{progress}%</span></div><div className="w-full bg-gray-200 rounded-full h-3"><div className="bg-indigo-600 h-3 rounded-full transition-all" style={{ width: `${progress}%` }} /></div></div>
      </div>
      <div className="bg-white rounded-lg border border-gray-200 p-6">
