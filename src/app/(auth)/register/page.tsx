      ...
      <div className="w-full max-w-md">
        <div className="bg-gray-900/50 backdrop-blur-lg rounded-lg shadow-md p-8">
          <div className="text-center mb-8">
            ...
            <img src="/feedflow-dark.svg" alt="FeedFlow" className="h-12 mx-auto mb-4 logo-dark" />
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/feedflow-primary.svg" alt="FeedFlow" className="h-12 mx-auto mb-4 logo-light" />
