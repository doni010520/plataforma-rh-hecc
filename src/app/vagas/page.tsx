    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          ...
          <h3 className="text-lg font-medium text-gray-100 mb-1">Nenhuma vaga encontrada</h3>
                ...
                {jobs.map((job) => (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {job.location && (
                        <span className="inline-flex items-center gap-1 text-xs bg-blue-900/30 text-blue-700 px-2.5 py-1 rounded-full">
                      ...
                      {job.type && (
                        <span className="inline-flex items-center gap-1 text-xs bg-emerald-900/30 text-emerald-400 px-2.5 py-1 rounded-full">
                          <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      {job.department && (
                        <span className="inline-flex items-center gap-1 text-xs bg-purple-900/30 text-purple-700 px-2.5 py-1 rounded-full">
                          {job.department.name}
                        </span>
                      )}
                    </div>
